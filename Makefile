...
#    Updated: 2024/02/22 12:01:04 by yliu             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(OBJS_DIR)/%.o:$(SRCS_DIR)/%.c $(HEADERS)
				@mkdir -p $(@D)
				@$(CC) $(CFLAGS) -DGOOGLE_TEST $(foreach dir_list,$(MAN_INC_DIR),-I$(dir_list)) -c $< -o $@
